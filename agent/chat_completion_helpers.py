...
from agent.chat_completion_helpers_iteration_limit import handle_max_iterations  # noqa: F401
...
# The iteration-limit summary unit moved to chat_completion_helpers_iteration_limit
# (AGENTS.md's ~2,000-line split rule). `handle_max_iterations` is re-exported at the top
# of this module, not here, because run_agent.py's lazy forwarder resolves it as an
# attribute of THIS module on every call and six test modules patch it by that path.
